...
function processFile(filePath) {
  ...
  if (match) {
    ...
    if (toAdd.length === 0) {
      console.log('OK:', filePath, '- already imports needed icons');
    ...
    console.log('Updated import in', filePath, '- added:', toAdd.join(', '));
  } else {
    ...
    if (src.includes(importStatement)) {
      console.log('OK (already contains full import):', filePath);
      return;
    }
