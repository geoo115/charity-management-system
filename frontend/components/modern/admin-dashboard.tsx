...
import { Users, UserCheck, Calendar, BarChart3, Activity, AlertTriangle, CheckCircle, Clock, TrendingUp, TrendingDown, Settings, Shield, Database, FileText, Bell, MessageSquare, Heart, Zap, Target, Award, Search, Filter, RefreshCw, Plus, Download, Upload, Eye, Edit, Trash2, ChevronRight, ArrowUp, ArrowDown, MapPin, Phone, Mail, Building, CreditCard, PieChart, LineChart, DollarSign, Package, Truck, Star, ThumbsUp, Siren, Monitor, X, AlertCircle, Info, CheckSquare, MoreHorizontal, Send } from 'lucide-react';
import {
  Card,
  CardContent,
  CardDescription,
